...
class fit_multi_render_dataset(torch.utils.data.Dataset):
    def __init__(self, model_dir, model_names, renderer,render_size=gin.REQUIRED, output_size=gin.REQUIRED,
        ...
        # NOTE: use for new part builds
        # obj_paths     = ['{}/fit_models/{}/simple.obj'.format(model_dir, item) for item in self.models]
        # texture_paths = ['{}/fit_models/{}/diffuse.png'.format(model_dir, item) for item in self.models]
        ...
        self.dropout_seq = iaa.Sequential([
                                            ...
                                            iaa.CoarseDropout(p=(0, 0.4), size_percent=(0.05, 0.25)),
